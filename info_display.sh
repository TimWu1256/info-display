...
# Reference
# https://askubuntu.com/questions/978977/windows-subsystem-for-linux-display-linux-distribution/978978#978978
...
# NOTE: To display all available toilet and figlet fonts use this one-liner:
# for i in ${TOILET_FONT_PATH:=/usr/share/figlet}/*.{t,f}lf; do 
#     j=${i##*/}; toilet -d "${i%/*}" -f "$j" "${j%.*}"; 
# done
